...
//    std::string chromosomeString = "-20.0 0.5 -1.5 1.0 1.0 2.0 3.0 1.0 4.0 -0.8 2.50 -1.50 -1.0 -2.0 -3.0 -1.0 1.0 5 1.0 6";
//    std::string chromosomeString = "-4.0 1.0 -3.0 2.0 3.6 4.0 6.0 2.0 8.0 -1.6 5.0 -3.0 -2.0 -4.0 -6.0 -2.0 3.0 5 3.0 6";
    ...
    model.addCarFromChromosome(chromosome, 0.0, 35);
